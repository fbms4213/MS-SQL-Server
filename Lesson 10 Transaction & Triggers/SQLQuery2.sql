...
---------------------------------------------
-- INSTEAD OF (əvvəl, əvəzinə)
-- AFTER/FOR  (sonra, üçün)
...
INSERT INTO Books VALUES(115, 'Book5', 500, 1900, 1, 11, 11, 2,'comment5', 4)
...
SELECT * FROM Libs
INSERT INTO Libs VALUES(3, 'Huseyn', 'Hemidov')
